...
public class StateChainTest {
    ...
    public void testGetTargetStateChain() {
        ...
        List<StateChain<StateMachineTest.States, StateMachineTest.Events>> targetStateChainList2 = stateMachine.getTargetStateChain(StateMachineTest.States.STATE1, StateMachineTest.Events.EVENT1);
